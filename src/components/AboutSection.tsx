  ...
  const pastoralTeam = [
    {
      ...
      role: 'Gembala Sidang (Senior Pastor)',
      ...
      badge: 'Gembala Sidang',
      instagram: 'https://www.instagram.com/ps.yohanessutono/',
    },
    {
      name: 'Ibu Santini',
      role: 'Ibu Gembala & Pelayanan Wanita',
